...
Public Declare Function GetAttributes Lib "kernel32" Alias "GetFileAttributesW" _
    (ByVal lpSpec As Long) As vbFileAttributes

Public Declare Function SetAttributes Lib "kernel32" Alias "SetFileAttributesW" _
    (ByVal lpSpec As Long, ByVal dwAttributes As Long) As vbFileAttributes
...
Public Function DirExists(sPath As String) As Boolean
    ...
    Attribs = GetAttributes(StrPtr(sPath))
