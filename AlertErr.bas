...
Private Declare Function GetWindowClassName Lib "user32" Alias "GetClassNameW" (ByVal hWnd As Long, ByVal lpClassName As Long, ByVal nBufLen As Long) As Long
Private Declare Function GetWindowThreadProcessId Lib "user32" (ByVal hWnd As Long, lpdwProcessId As Long) As Long
Private Declare Function GetCurrentThreadId Lib "kernel32" () As Long
Private Declare Function GetCurrentProcessId Lib "kernel32" () As Long
Private Declare Function GetWindowLong Lib "user32" Alias "GetWindowLongW" (ByVal hWnd As Long, ByVal nIndex As Long) As Long
Private Declare Function GetModuleFileName Lib "kernel32" Alias "GetModuleFileNameW" (ByVal hModule As Long, ByVal lpFileName As Long, ByVal nSize As Long) As Long ' ©Rd
...
Private Function GetClassName(ByVal hWnd As Long) As String
    ...
    If (GetWindowClassName(hWnd, StrPtr(ClassName), BufLength)) Then
...
Public Function GetClientSpec() As String
    ...
    hInst = GetWindowLong(GetModuleHandle(0&), GWL_HINSTANCE)
    ' Get the module file name
    sModName = String$(ONE_KB, vbNullChar)
    rc = GetModuleFileName(hInst, StrPtr(sModName), ONE_KB)
...
Public Function FolderExists(sPath As String) As Boolean
    Dim Attribs As Long: Attribs = GetAttributes(StrPtr(sPath))
